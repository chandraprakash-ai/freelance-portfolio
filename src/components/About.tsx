            ...
            <div className="about-container">
                ...
                >
                    ...
                    <div className="about-text-wrapper">
                        ...
                        <p className="about-text">
                            Our mission is simple: to deliver premium, enterprise-grade web solutions at affordable rates for growing businesses. Whether you need a high-converting landing page, a sleek portfolio, or a robust corporate website, Arcbyte brings your vision to life with precision and speed. We serve clients Globally.
                    </p>
                    </div>
                </motion.div>
            </div>
