        ...
        >
            <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
                <Link href="/" className="group">
                    <h1 className="text-xl md:text-2xl font-serif font-bold text-charcoal group-hover:text-green transition-colors">
                        Chandraprakash Prajapati
                    </h1>
                    <p className="text-xs text-charcoal/70 tracking-wide">
                ...
                <div className="hidden md:flex items-center gap-6">
                    <Link href="#portfolio" className="text-sm font-medium text-charcoal hover:text-green transition-colors">
                        Portfolio
                    </Link>
                    <Link href="#services" className="text-sm font-medium text-charcoal hover:text-green transition-colors">
                        Services
                    </Link>
                    <a
            ...
            {isMobileMenuOpen && (
                <div className="md:hidden absolute top-full left-0 right-0 bg-white border-t border-gray-100 shadow-lg p-4 flex flex-col gap-4">
                    <Link
                        href="#portfolio"
                        className="text-charcoal hover:text-green py-2"
